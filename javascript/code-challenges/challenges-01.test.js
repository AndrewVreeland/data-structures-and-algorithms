...
const addExclamation = (arr) => {
  let newArr = [];
  arr.forEach(text => newArr.push(text + '!'));
  return newArr;
};
...
const allUpperCase = (arr) => {
  let newArr = []
  arr.forEach(text => newArr.push(text.toUpperCase()));
  return newArr
...
const speaker = (words, callback) => {
  let newArr = [];
  words.forEach(text => newArr.push(callback(text)))
  console.log(newArr);
  return newArr;
